...
class SOLUTION:
    ...
    def start_simulation(self, directOrGUI):
        ...
        self.generate_body()
        self.generate_brain()
        os.system(f"python3 simulate.py {directOrGUI} {self.myID} false 2&>1 &")
    ...
    def generate_body(self):
        ...
        pyrosim.Send_Cube(name="Torso", pos=[0,0,2] , size=[2,2,.25])
        
        pyrosim.Send_Joint(name="Torso_BackLeg", parent="Torso", child="BackLeg", type="revolute", position=[0,-1,2], jointAxis = "1 0 0")
        ...
        pyrosim.Send_Joint(name="Torso_FrontLeg", parent="Torso", child="FrontLeg", type="revolute", position=[0,1,2], jointAxis = "1 0 0")
        ...
        pyrosim.Send_Joint(name="Torso_LeftLeg", parent="Torso", child="LeftLeg", type="revolute", position=[-1,0,2], jointAxis = "0 1 0")
        ...
        pyrosim.Send_Joint(name="Torso_RightLeg", parent="Torso", child="RightLeg", type="revolute", position=[1,0,2], jointAxis = "0 1 0")
