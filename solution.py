...
class SOLUTION:
    ...
    def generate_body(self, aOrB):
        if aOrB == "A":
            ...
            pyrosim.Send_Cube(name="BackLeg", pos=[0,-0.5,0] , size=[0.5,1,0.25])
            ...
            pyrosim.Send_Cube(name="LowerBackLeg", pos=[0,0,-0.5] , size=[0.5,0.25,1])
            
            pyrosim.Send_Joint(name="Torso_FrontLeg", parent="Torso", child="FrontLeg", type="revolute", position=[0,0.5,2], jointAxis = "1 0 0")
            pyrosim.Send_Cube(name="FrontLeg", pos=[0,0.5,0] , size=[0.5,1,0.25])
            ...
            pyrosim.Send_Cube(name="LowerFrontLeg", pos=[0,0,-0.5] , size=[0.5,0.25,1])
            
            pyrosim.Send_Joint(name="Torso_LeftLeg", parent="Torso", child="LeftLeg", type="revolute", position=[-0.5,0,2], jointAxis = "0 1 0")
            pyrosim.Send_Cube(name="LeftLeg", pos=[-0.5,0,0] , size=[1,0.5,0.25])
            ...
            pyrosim.Send_Cube(name="LowerLeftLeg", pos=[0,0,-0.5] , size=[0.25,0.5,1])
            
            pyrosim.Send_Joint(name="Torso_RightLeg", parent="Torso", child="RightLeg", type="revolute", position=[0.5,0,2], jointAxis = "0 1 0")
            pyrosim.Send_Cube(name="RightLeg", pos=[0.5,0,0] , size=[1,0.5,0.25])
            ...
            pyrosim.Send_Cube(name="LowerRightLeg", pos=[0,0,-0.5] , size=[0.25,0.5,1])
